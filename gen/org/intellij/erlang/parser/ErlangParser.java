...
public class ErlangParser implements PsiParser {
  ...
  public ASTNode parse(IElementType root_, PsiBuilder builder_) {
    ...
    if (root_ == ERL_ADDITIVE_EXPRESSION) {
      ...
      result_ = after_clause(builder_, 0);
    }
    else if (root_ == ERL_AFTER_CLAUSE_BODY) {
      result_ = after_clause_body(builder_, 0);
    }
      ...
      result_ = argument_definition(builder_, 0);
    }
    else if (root_ == ERL_ARGUMENT_DEFINITION_LIST) {
      result_ = argument_definition_list(builder_, 0);
    }
      ...
      result_ = type_guard(builder_, 0);
    }
    else if (root_ == ERL_TYPE_REF) {
      result_ = type_ref(builder_, 0);
    }
    else if (root_ == ERL_TYPE_SIG) {
      result_ = type_sig(builder_, 0);
    }
    else if (root_ == ERL_TYPE_SIG_GUARD) {
      result_ = type_sig_guard(builder_, 0);
    }
    else if (root_ == ERL_TYPED_ATTR_VAL) {
      result_ = typed_attr_val(builder_, 0);
    }
    else if (root_ == ERL_TYPED_EXPR) {
      result_ = typed_expr(builder_, 0);
    }
    else if (root_ == ERL_TYPED_RECORD_FIELDS) {
      result_ = typed_record_fields(builder_, 0);
    }
    else {
  ...
  private static boolean argument_definition_list_2(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "argument_definition_list_2", pos_)) break;
  ...
  public static boolean atom_attribute(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<attribute>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
  ...
  static boolean atomic(PsiBuilder builder_, int level_) {
    ...
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = atomic_0(builder_, level_ + 1);
    if (!result_) result_ = consumeToken(builder_, ERL_INTEGER);
    if (!result_) result_ = atomic_2(builder_, level_ + 1);
  ...
  // q_atom !'('
  private static boolean atomic_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "atomic_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = q_atom(builder_, level_ + 1);
    result_ = result_ && atomic_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // !'('
  private static boolean atomic_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "atomic_0_1")) return false;
    boolean result_ = false;
  ...
  // string_literal+
  private static boolean atomic_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "atomic_2")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    ...
    while (result_) {
      ...
      if (!empty_element_parsed_guard_(builder_, "atomic_2", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  /* ********************************************************** */
  // !'(' <<p1>> | '(' <<p1>> ')'
  static boolean attribute_tail(PsiBuilder builder_, int level_, final Parser p1) {
    if (!recursion_guard_(builder_, level_, "attribute_tail")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = attribute_tail_0(builder_, level_ + 1, p1);
    if (!result_) result_ = attribute_tail_1(builder_, level_ + 1, p1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // !'(' <<p1>>
  private static boolean attribute_tail_0(PsiBuilder builder_, int level_, final Parser p1) {
    if (!recursion_guard_(builder_, level_, "attribute_tail_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = attribute_tail_0_0(builder_, level_ + 1);
    result_ = result_ && p1.parse(builder_, level_);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // !'('
  private static boolean attribute_tail_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "attribute_tail_0_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_, level_, _NOT_, null);
    result_ = !consumeToken(builder_, ERL_PAR_LEFT);
    exit_section_(builder_, level_, marker_, null, result_, false, null);
  ...
  // '(' <<p1>> ')'
  private static boolean attribute_tail_1(PsiBuilder builder_, int level_, final Parser p1) {
    if (!recursion_guard_(builder_, level_, "attribute_tail_1")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, ERL_PAR_LEFT);
    result_ = result_ && p1.parse(builder_, level_);
  ...
  public static boolean bin_base_type(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<type>", ERL_UNI_PATTERN, ERL_VAR)) return false;
    boolean result_ = false;
  ...
  static boolean bin_base_type_list(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "", ERL_UNI_PATTERN, ERL_VAR)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, null);
  ...
  private static boolean bin_element_list_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "bin_element_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean bit_type(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<type>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, "<type>");
    result_ = q_atom(builder_, level_ + 1);
  ...
  private static boolean bit_type_list_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "bit_type_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  private static boolean call_exprs_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "call_exprs_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean config_bin_list_expression(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, ERL_BIN_START);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, config_bin_list_expression_1(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, ERL_BIN_END) && result_;
    exit_section_(builder_, level_, marker_, ERL_BINARY_EXPRESSION, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  /* ********************************************************** */
  // !(')' | '>>' | ']' | '}')
  static boolean config_expr_recover(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "config_expr_recover")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_, level_, _NOT_, null);
    result_ = !config_expr_recover_0(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, null, result_, false, null);
    return result_;
  }

  // ')' | '>>' | ']' | '}'
  private static boolean config_expr_recover_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "config_expr_recover_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
  ...
  static boolean config_exprs(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, level_, marker_, null, result_, pinned_, config_expr_recover_parser_);
    return result_ || pinned_;
  }
  ...
  private static boolean config_exprs_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "config_exprs_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean config_list_expression(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, config_list_expression_1(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, ERL_BRACKET_RIGHT) && result_;
    exit_section_(builder_, level_, marker_, ERL_LIST_EXPRESSION, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  public static boolean config_tuple_expression(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, config_tuple_expression_1(builder_, level_ + 1));
  ...
  private static boolean cr_clauses_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "cr_clauses_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean export(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && attribute_tail(builder_, level_ + 1, export_functions_parser_);
  ...
  public static boolean export_function(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<export function>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
  ...
  private static boolean export_function_list_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "export_function_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean export_type_attribute(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && attribute_tail(builder_, level_ + 1, export_types_parser_);
  ...
  private static boolean export_type_list_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "export_type_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  static boolean exprs(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, level_, marker_, null, result_, false, exprs_recover_parser_);
    return result_;
  }
  ...
  private static boolean field_type_list_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "field_type_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  private static boolean form_10(PsiBuilder builder_, int level_) {
    ...
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_, level_, _NOT_, null);
    result_ = !eofOrSpace(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, null, result_, false, null);
    return result_;
  }
  ...
  private static boolean forms_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "forms_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  private static boolean fun_clauses_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "fun_clauses_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean fun_type_sigs(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<fun type sigs>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
  ...
  public static boolean function(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<function>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
  ...
  private static boolean function_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "function_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean function_with_arity(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<function with arity>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
  ...
  public static boolean function_with_arity_variables(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<function with arity variables>", ERL_UNI_PATTERN, ERL_VAR)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
  ...
  private static boolean guard_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "guard_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  private static boolean if_clauses_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "if_clauses_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean import_function(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<import function>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
  ...
  private static boolean import_function_list_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "import_function_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean lc_expression(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && expression(builder_, level_ + 1, -1);
    exit_section_(builder_, level_, marker_, ERL_LC_EXPRESSION, result_, false, null);
    return result_;
  }
  ...
  private static boolean lc_exprs_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "lc_exprs_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  private static boolean left_accessors_1(PsiBuilder builder_, int level_) {
    ...
    while (result_) {
      ...
      if (!empty_element_parsed_guard_(builder_, "left_accessors_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  private static boolean list_atom_with_arity_expression_2(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "list_atom_with_arity_expression_2", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  static boolean list_op(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "", ERL_OP_PLUS_PLUS, ERL_OP_MINUS_MINUS)) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
  ...
  /* ********************************************************** */
  // &<<isModeOn "MACRO">> q_var
  static boolean macro_arg_var(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_arg_var")) return false;
    if (!nextTokenIs(builder_, "", ERL_UNI_PATTERN, ERL_VAR)) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = macro_arg_var_0(builder_, level_ + 1);
    result_ = result_ && q_var(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // &<<isModeOn "MACRO">>
  private static boolean macro_arg_var_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_arg_var_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_, level_, _AND_, null);
    result_ = isModeOn(builder_, level_ + 1, "MACRO");
    exit_section_(builder_, level_, marker_, null, result_, false, null);
    return result_;
  }

  /* ********************************************************** */
  // <<enterMode "MACRO">> macros_body <<exitMode "MACRO">>
  static boolean macro_body(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macro_body")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = enterMode(builder_, level_ + 1, "MACRO");
    result_ = result_ && macros_body(builder_, level_ + 1);
    result_ = result_ && exitMode(builder_, level_ + 1, "MACRO");
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  public static boolean macros_arg(PsiBuilder builder_, int level_) {
    ...
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = macros_arg_0(builder_, level_ + 1);
  ...
  // &<<isModeOn "MACRO">>
  private static boolean macros_arg_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "macros_arg_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_, level_, _AND_, null);
    result_ = isModeOn(builder_, level_ + 1, "MACRO");
    exit_section_(builder_, level_, marker_, null, result_, false, null);
  ...
  /* ********************************************************** */
  // '-' 'define' '(' macros_name argument_definition_list? ',' <<guarded macro_body>> ')'
  public static boolean macros_definition(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, ERL_COMMA)) && result_;
    result_ = pinned_ && report_error_(builder_, guarded(builder_, level_ + 1, macro_body_parser_)) && result_;
    result_ = pinned_ && consumeToken(builder_, ERL_PAR_RIGHT) && result_;
  ...
  public static boolean macros_name(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<macros name>", ERL_ATOM, ERL_VAR)) return false;
    boolean result_ = false;
  ...
  // (',' map_entry)*
  private static boolean map_entries_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "map_entries_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!map_entries_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "map_entries_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' map_entry
  private static boolean map_entries_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "map_entries_1_0")) return false;
    boolean result_ = false;
    boolean pinned_ = false;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, null);
    result_ = consumeToken(builder_, ERL_COMMA);
  ...
  public static boolean map_entry(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, level_, marker_, ERL_MAP_ENTRY, result_, pinned_, tuple_recoverer_parser_);
    return result_ || pinned_;
  }
  ...
  private static boolean map_entry_1(PsiBuilder builder_, int level_) {
    ...
    map_entry_1_0(builder_, level_ + 1);
    return true;
  }

  // ('=>' | ':=') expression
  private static boolean map_entry_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "map_entry_1_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = map_entry_1_0_0(builder_, level_ + 1);
    result_ = result_ && expression(builder_, level_ + 1, -1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // '=>' | ':='
  private static boolean map_entry_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "map_entry_1_0_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, ERL_ASSOC);
  ...
  public static boolean model_field(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<model field>", ERL_UNI_PATTERN, ERL_VAR)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
  ...
  private static boolean model_field_list_2(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "model_field_list_2", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean module_ref(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<module ref>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
  ...
  public static boolean q_atom(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<q atom>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, "<q atom>");
    result_ = consumeToken(builder_, ERL_ATOM);
    if (!result_) result_ = macros_arg(builder_, level_ + 1);
  ...
  public static boolean q_var(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<q var>", ERL_UNI_PATTERN, ERL_VAR)) return false;
    boolean result_ = false;
  ...
  /* ********************************************************** */
  // (q_atom | macro_arg_var | '_') '=' (qualified_atom_expression | expression)
  ...
  private static boolean record_field_0(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = q_atom(builder_, level_ + 1);
    if (!result_) result_ = macro_arg_var(builder_, level_ + 1);
    if (!result_) result_ = consumeToken(builder_, ERL_UNI_PATTERN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  public static boolean record_field_ref(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, ERL_DOT);
    pinned_ = result_; // pin = 1
    result_ = result_ && record_field_ref_1(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, ERL_RECORD_FIELD, result_, pinned_, null);
    return result_ || pinned_;
  }

  // q_atom | macro_arg_var
  private static boolean record_field_ref_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "record_field_ref_1")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = q_atom(builder_, level_ + 1);
    if (!result_) result_ = macro_arg_var(builder_, level_ + 1);
  ...
  private static boolean record_fields_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "record_fields_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  private static boolean record_head_1_1_0_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && record_head_1_1_0_1_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // &(!('('))
  private static boolean record_head_1_1_0_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "record_head_1_1_0_1_1")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_, level_, _AND_, null);
    result_ = record_head_1_1_0_1_1_0(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, null, result_, false, null);
    return result_;
  }

  // !('(')
  private static boolean record_head_1_1_0_1_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "record_head_1_1_0_1_1_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_, level_, _NOT_, null);
    result_ = !record_head_1_1_0_1_1_0_0(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, null, result_, false, null);
    return result_;
  }

  // ('(')
  private static boolean record_head_1_1_0_1_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "record_head_1_1_0_1_1_0_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, ERL_PAR_LEFT);
    exit_section_(builder_, marker_, null, result_);
  ...
  public static boolean rule(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<rule>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
  ...
  private static boolean rule_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "rule_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean rule_clause(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<rule clause>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
  ...
  public static boolean spec_fun(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<spec fun>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
  ...
  private static boolean top_type_list_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "top_type_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean try_catch(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<try catch>", ERL_AFTER, ERL_CATCH)) return false;
    boolean result_ = false;
  ...
  private static boolean try_clauses_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "try_clauses_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean type_definition(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 2
    result_ = result_ && attribute_tail(builder_, level_ + 1, type_body_parser_);
  ...
  private static boolean type_guard_list_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "type_guard_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean type_ref(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<type ref>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
  ...
  private static boolean type_sigs_list_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "type_sigs_list_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean typed_expr(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<typed expr>", ERL_QMARK, ERL_ATOM)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
  ...
  private static boolean typed_exprs_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "typed_exprs_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  public static boolean record2_expression(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<expression>", ERL_RADIX, ERL_QMARK)) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, "<expression>");
  ...
  public static boolean parenthesized_expression(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<expression>", ERL_PAR_LEFT)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, null);
    result_ = consumeToken(builder_, ERL_PAR_LEFT);
  ...
  final static Parser config_expr_recover_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return config_expr_recover(builder_, level_ + 1);
    }
  };
  final static Parser export_functions_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return export_functions(builder_, level_ + 1);
    }
  };
  final static Parser export_types_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return export_types(builder_, level_ + 1);
    }
  };
  ...
  final static Parser macro_body_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return macro_body(builder_, level_ + 1);
    }
  };
  ...
  final static Parser type_body_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return type_body(builder_, level_ + 1);
    }
  };
}
